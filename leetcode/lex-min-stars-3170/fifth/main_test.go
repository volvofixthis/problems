...
// 	o1 bool
// }{
// 	{[]byte{'a', ' ', 'a'}, []byte{'a', 'b'}, true},
// 	{[]byte{'a', ' ', 'a', 'b'}, []byte{'a', 'a'}, false},
// 	{[]byte{'a', 'a', 'b'}, []byte{'a', 'a'}, false},
// 	{[]byte{'a', 'a', 'd'}, []byte{'a', 'b'}, true},
// }
//
// func TestFunc2(t *testing.T) {
// 	for i, test := range tests2 {
// 		t.Run(fmt.Sprintf("test-%d", i+1), func(t *testing.T) {
// 			assert.Equal(t, test.o1, less(test.i1, test.i2), "should be equal")
// 		})
// 	}
// }
